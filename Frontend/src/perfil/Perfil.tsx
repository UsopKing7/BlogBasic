...
import { FaSignOutAlt, FaArrowLeft, FaEnvelope, FaCalendarAlt, FaClock } from 'react-icons/fa'
      ...
      <div className="perfil-grid">
        ...
        <div className="usuario-card">
          <img 
            ...
            src={username?.perfil_logo || `https://ui-avatars.com/api/?name=${username?.username}&background=6C5CE7&color=fff`} 
          ...
          <p className="usuario-info">
            <FaCalendarAlt /> Miembro desde: {formatearFecha(String(username?.registrado_en)) || 'Fecha no disponible'}
          </p>
              ...
              posts.map(post => (
                <div key={post.id} className="post-card">
                  <div className="post-header">
                    <img 
                      src={post.perfil_logo || `https://ui-avatars.com/api/?name=${post.username}&background=6C5CE7&color=fff`} 
                      alt={post.username} 
